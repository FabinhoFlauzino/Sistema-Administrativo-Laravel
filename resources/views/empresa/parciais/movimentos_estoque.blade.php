<div class="col-md-12">
    <div class="card">
        @if($empresa->tipo === 'fornecedor')
            <div class="card-header">Últimos itens comprado deste Fornecedor: </div>
        @else
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('movimentos_estoque.destroy', $movimentoEstoque->id) }}" accept-charset="UTF-8" style="display:inline">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select id="produto-ajax" name="produto_id" type="text" class="form-control"></select>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
